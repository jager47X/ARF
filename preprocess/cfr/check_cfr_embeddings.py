...
def main():
    ...
    try:
        ...
        docs_with_doc_embedding = coll.count_documents({"embedding": {"$exists": True, "$nin": [None, []]}})
        ...
        logger.info("")
        logger.info("Document-level embeddings:")
        ...
        logger.info("")
        logger.info("Section-level embeddings:")
        ...
        logger.info("")
        logger.info("Documents by section embedding status:")
